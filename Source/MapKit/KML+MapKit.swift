...
open class KMLMapKitOverlayRenderer: MKOverlayRenderer, KMLOverlayRenderer {
}
open class KMLMapKitPolygonRenderer: MKPolygonRenderer, KMLOverlayPathRenderer {
}
open class KMLMapKitPolylineRenderer: MKPolylineRenderer, KMLOverlayPathRenderer {
}
...
open class KMLOverlayPolygon: MKPolygon, KMLOverlay {
    ...
    open func renderer() -> KMLOverlayRenderer {
        let renderer: KMLMapKitPolygonRenderer = KMLMapKitPolygonRenderer(polygon: self)
...
open class KMLOverlayPolyline: MKPolyline, KMLOverlay {
    ...
    open func renderer() -> KMLOverlayRenderer {
        let renderer: KMLMapKitPolylineRenderer = KMLMapKitPolylineRenderer(polyline: self)
    ...
    fileprivate func initOverlay() {
        for placemark: KMLPlacemark in placemarks {
            ...
            for polygon: KMLPolygon in polygons {
                overlays.append(KMLOverlayPolygon(coordinates: &polygon.coordinates, count: polygon.coordinates.count))
            }
